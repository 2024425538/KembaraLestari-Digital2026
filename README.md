# KembaraLestari-Digital2026<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        * {
        ...
        /* Category Section */
        .category {
            background: linear-gradient(180deg, var(--pale-green) 0%, var(--cream) 100%);
        }
        ...
        .category-card::before {
            ...
            right: 0;
            height: 5px;
            background: linear-gradient(90deg, var(--primary-green), var(--accent-green), var(--gold));
        }
        ...
        .timeline-container::before {
            ...
            width: 6px;
            height: 100%;
            background: linear-gradient(to bottom, var(--primary-green), var(--accent-green), var(--gold));
            border-radius: 3px;
        }
        ...
        .prizes::before {
            ...
            width: 800px;
            height: 800px;
            background: radial-gradient(circle, var(--pale-green) 0%, transparent 60%);
            pointer-events: none;
        }
        ...
        .prize-card.bronze::before {
            background: linear-gradient(90deg, #CD7F32, #E6A869, #CD7F32);
        }
        ...
        .prize-card.gold .rank-badge {
            background: linear-gradient(135deg, #FFD700, #FFC107);
            color: var(--dark);
        }

        .prize-card.silver .rank-badge {
            background: linear-gradient(135deg, #C0C0C0, #E8E8E8);
            color: var(--dark);
        }

        .prize-card.bronze .rank-badge {
        ...
        .judging-row:last-child {
            border-bottom: none;
        }

        .judging-row:not(.header):hover {
            background: var(--pale-green);
            padding-left: 50px;
        }
        ...
        .judging-row .percentage {
            font-weight: 700;
            color: var(--primary-green);
            font-size: 1.2rem;
        }

        .judging-row.header .percentage {
            color: var(--white);
        }
        ...
        footer::before {
            ...
            right: 0;
            height: 5px;
            background: linear-gradient(90deg, var(--primary-green), var(--accent-green), var(--gold), var(--accent-green), var(--primary-green));
        }
        ...
        <div class="container">
            <div class="stats-container">
                ...
                <div class="stat-item" data-count="3">
                    ...
                    <div class="stat-label">
                        <span class="en">Cash Prizes</span>
                        <span class="bm">Hadiah Wang Tunai</span>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="category-cards">
                ...
                <div class="category-card">
                    ...
                    <h3>
                        <span class="en">Diploma Students</span>
                        <span class="bm">Pelajar Diploma</span>
                    </h3>
                    <p>
                        <span class="en">Open exclusively to diploma level students from any institution across Malaysia</span>
                        <span class="bm">Terbuka khas kepada pelajar peringkat diploma dari mana-mana institusi di seluruh Malaysia</span>
                    </p>
                </div>
                <div class="category-card">
                    <div class="icon">
            ...
            <div class="requirements-grid">
                <div class="requirement-card">
                    ...
                    <ul>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            <span class="en">Must be a Diploma student from any institution</span>
                            <span class="bm">Mestilah pelajar Diploma dari mana-mana institusi</span>
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
    ...
    <section class="prizes" id="prizes">
        <div class="container">
            <div class="section-title">
                ...
                <p>
                    <span class="en">Amazing prizes await the winners of this competition!</span>
                    <span class="bm">Hadiah lumayan menanti para pemenang pertandingan ini!</span>
                </p>
            </div>
            <div class="prizes-container">
                <div class="prize-card silver">
                    ...
                    <div class="prize-amount">
                        <span class="en">To be announced</span>
                        <span class="bm">Akan diumumkan</span>
                    </div>
                </div>
            ...
            <div class="contact-container">
                <div class="contact-card">
                    ...
                    <div class="phone">
                        ...
                        <span>
                            <span class="en">To be added</span>
                            <span class="bm">Akan ditambah</span>
                        </span>
                    </div>
                </div>
            </div>
